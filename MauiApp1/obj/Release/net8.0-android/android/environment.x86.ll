...
@dso_cache = dso_local local_unnamed_addr global [716 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 202764387, ; hash 0xc15f063, from name: SQLitePCLRaw.lib.e_sqlite3.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1391444694, ; hash 0x52efc2d6, from name: aot-SQLitePCLRaw.batteries_green.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1628285525, ; hash 0x610daa55, from name: libaot-SQLitePCLRaw.lib.e_sqlite3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-SQLitePCLRaw.lib.e_sqlite3.dll.so
		ptr null; void* handle (0x0)
	}, ; 259
	...
	%struct.DSOCacheEntry {
		i64 1941944708, ; hash 0x73bfb984, from name: libaot-SQLitePCLRaw.batteries_green.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-SQLitePCLRaw.batteries_green.dll.so
		ptr null; void* handle (0x0)
	}, ; 315
	...
	%struct.DSOCacheEntry {
		i64 2006355194, ; hash 0x77968cfa, from name: aot-SQLitePCLRaw.lib.e_sqlite3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-SQLitePCLRaw.lib.e_sqlite3.dll.so
		ptr null; void* handle (0x0)
	}, ; 327
	...
	%struct.DSOCacheEntry {
		i64 2019533804, ; hash 0x785fa3ec, from name: SQLitePCLRaw.lib.e_sqlite3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-SQLitePCLRaw.lib.e_sqlite3.dll.so
		ptr null; void* handle (0x0)
	}, ; 332
	...
	%struct.DSOCacheEntry {
		i64 2207986589, ; hash 0x839b339d, from name: aot-SQLitePCLRaw.batteries_green
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-SQLitePCLRaw.batteries_green.dll.so
		ptr null; void* handle (0x0)
	}, ; 370
	...
	%struct.DSOCacheEntry {
		i64 2296306685, ; hash 0x88dedbfd, from name: aot-SQLitePCLRaw.lib.e_sqlite3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-SQLitePCLRaw.lib.e_sqlite3.dll.so
		ptr null; void* handle (0x0)
	}, ; 391
	...
	%struct.DSOCacheEntry {
		i64 2973967953, ; hash 0xb1432651, from name: libaot-SQLitePCLRaw.batteries_green
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-SQLitePCLRaw.batteries_green.dll.so
		ptr null; void* handle (0x0)
	}, ; 507
	...
	%struct.DSOCacheEntry {
		i64 3374649296, ; hash 0xc9250fd0, from name: SQLitePCLRaw.batteries_green.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-SQLitePCLRaw.batteries_green.dll.so
		ptr null; void* handle (0x0)
	}, ; 580
	...
	%struct.DSOCacheEntry {
		i64 3641967938, ; hash 0xd9140542, from name: SQLitePCLRaw.batteries_green
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.35_name, ; name: libaot-SQLitePCLRaw.batteries_green.dll.so
		ptr null; void* handle (0x0)
	}, ; 619
	...
	%struct.DSOCacheEntry {
		i64 4013431863, ; hash 0xef381c37, from name: libaot-SQLitePCLRaw.lib.e_sqlite3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-SQLitePCLRaw.lib.e_sqlite3.dll.so
		ptr null; void* handle (0x0)
	}, ; 676
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [148 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
